...
$animals = Json::decode(file_get_contents(__DIR__ . '/sources/united.cleaned.json'));
...
$output = [
	...
	"concept" => [
		"cz_trees_shrubs" => [
			...
			"names" => [
				"cs" => [
					"name" => "Stromy a keře ČR",
					"description" => "Nejčastější stromy a keře vyskytující se v České republice."
				],
				"en" => [
					"name" => "Czech Trees and Shrubs",
					"description" => "Most common trees and shrubs present in Czech Republic."
				]
			]
		]
	]
