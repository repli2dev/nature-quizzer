...
App.Translations.cs = {
	...
	'index': {
		...
		'text_adaptive': 'Naše poznávačka přírody nabízí adaptabilní procvičování, tedy aplikace se přizpůsobí tomu jaké již máte vědomosti a podle toho volí otázky a frekvenci opakování. Zároveň se aplikace snaží vybrat takové organismy (zvířata, rostliny...) jejichž procvičení je nejužitečnější a zároveň tak, aby vás to nepřestalo bavit.',
		'heading_specialized': 'Specializovaný systém',
		'text_specialized': 'Obecných výukových systémů na faktografické znalosti (kvízů a poznávaček) je na internetu spousta... naše poznávačka se ale soustředí (a je tedy optimalizovaná) speciálně na konkrétní oblasti biologie užitečné pro širokou veřejnost. Jednotlivé otázky nejsou předem sestavené, ale máme pro každý organismus k dispozici více jeho fotografií.',
